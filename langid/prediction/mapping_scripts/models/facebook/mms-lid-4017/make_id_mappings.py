...
def create_mappings():
  ...
  These IDs come from SIL's dictionary of language identifier codes
  """
  ...
  # "ksa" deprecated for Kizamani: https://iso639-3.sil.org/code/ksa
  ksa_id = next(id for id, label in id2label.items() if label == "ksa")
  modified_id2label[ksa_id] = "izm"


  ## map model's internal ids (int) to their language identifier (str) which is the global id
  ## The _ separates variations from countries, such as en_US
